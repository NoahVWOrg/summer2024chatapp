...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    chattyAuthUserSubject.add(
      ChattyAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<ChattyAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  ChattyAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = ChattyAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    chattyAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
